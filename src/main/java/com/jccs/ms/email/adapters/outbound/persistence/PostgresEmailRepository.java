package com.jccs.ms.email.adapters.outbound.persistence;

import com.jccs.ms.email.adapters.outbound.persistence.entities.EmailEntity;
import com.jccs.ms.email.application.domain.Email;
import com.jccs.ms.email.application.domain.PageInfo;
